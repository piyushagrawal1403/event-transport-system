...
import { Car, Phone, KeyRound, Clock, MapPin, Users, ArrowRight, Building2, PartyPopper, Minus, Plus, LogOut, CheckCircle2, Navigation, Flag, MessageSquare, CalendarDays, Headset, ChevronDown, X } from 'lucide-react';
                ...
                {hasActiveRides && (
                  <div className="space-y-3">
                    ...
                    {activeRides.map((ride) => (
                      <div key={ride.id} className="wedding-card overflow-hidden">
